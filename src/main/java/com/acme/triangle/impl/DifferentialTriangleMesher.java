...
/**
 * Runs a primary mesher and a reference mesher on the same input, validates the
 * primary against the structural contract, and returns the primary's output.
 * When the primary's mesh is invalid, the {@link DivergenceHandler} is notified
 * so the caller can log (shadow mode) or throw (strict mode).
 * <p>
